...
BootParams.setDefault = function (req, res, next) {
    ...
    var params = {
        ...
        serial_speed: req.params.serial_speed
    };
...
BootParams.updateDefault = function (req, res, next) {
    ...
    params.serial_speed = req.params.serial_speed;
...
BootParams.setByUuid = function (req, res, next) {
    var rules = {
        ...
        'serial_speed': ['optional', 'isStringType', 'isTrim'],
        'kernel_args': ['optional', 'isObjectType']
    };
    ...
    values.serial_speed = req.params.serial_speed;
