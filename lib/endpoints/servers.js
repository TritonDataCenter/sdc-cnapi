 ...
 * @section Servers
 *
 * @param uuids {String} Comma seperated list of UUIDs to look up
 * @param setup {Boolean} Return only setup servers
 *
 * @example GET /servers
 ...
 * @section Servers
 *
 * @param boot_platform {String} The platform image to be used on next boot
 * @param default_console {String} Console type
 * @param reserved {Boolean} Server is available for provisioning
 * @param serial {String} Serial device
 * @param serial_speed {Number} Serial speed value
 * @param setup {String} Indicate whether server is set up
 * @param traits {String} Server traits
 *
 ...
 * @endpoint PUT /servers/:server\_uuid/setup
 * @section Servers
 *
 * @response 204 None Server reset initiated successfully
 ...
 *
 * @name ServerSetup
 * @endpoint PUT /servers/:server_uuid/factory-reset
 * @section Servers
 *
 * @response 200 Object Returns object containing workflow id
