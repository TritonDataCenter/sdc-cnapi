...
var GENERAL_KEYS = [
    ...
    'system_type',             // sysinfo['System Type']
...
ModelServer.prototype.setup = function (params, callback) {
    ...
    if (params.hasOwnProperty('disk_exclude')) {
        wfParams.disk_exclude = params.disk_exclude;
    }
...
ModelServer.updateFromSysinfo = function updateFromSysinfo(sysinfo, callback) {
    ...
    vasync.pipeline({funcs: [
        function _updateNapi(_, cb) {
            ...
            _setField(updateObj, 'system_type', 'System Type');
