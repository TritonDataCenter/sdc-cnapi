    ...
    ModelServer.getUfds().search(baseDn, options, function (err, servers) {
        ...
        self.cacheGetServerStatus(
            function (statusError, status) {
                ...
                self.log.info("Status was %s, server status");
    ...
    function (error) {
        ...
        self.addServerToUfds(
            ...
            function (createError, createdServer) {
                ...
                self.cacheSetServerStatus(self.values.status, function (statusError) {
                    if (statusError) {
                        self.log.error('Error setting server status for %s', self.uuid);
                    }
