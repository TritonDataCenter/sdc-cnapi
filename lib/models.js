...
function sysinfoToLdapObject(sysinfo) {
    return {
        ...
        headnode:
            sysinfo['Boot Parameters']['headnode']
                               ? 'true' : 'false',
        bootargs:
            Object
...
function createTaskHandler(self, callback) {
...
function (serverUuid, task, params, callback) {
...
Model.prototype.nop = function (serverUuid, params, callback) {
    this.sendProvisionerTask(
        serverUuid,
        'nop',
        params,
        createTaskHandler(this, callback));
};

Model.prototype.createVm = function (serverUuid, params, callback) {
    this.sendProvisionerTask(
        serverUuid,
        'machine_create',
        params,
...
Model.prototype.destroyVm = function (serverUuid, params, callback) {
    this.sendProvisionerTask(
        serverUuid,
        'machine_destroy',
        params,
