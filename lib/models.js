...
function serverJson(record) {
    return {
        ...
        memory_available_bytes: record.memoryavailablebytes,
        memory_arc_bytes: record.memoryarcbytes,
        memory_total_bytes: record.memorytotalbytes
    };
}

function sysinfoToLdapServer(sysinfo) {
    var bootargs =
        Object
    ...
    return {
        ...
        bootargs: bootargs,
        memoryavailablebytes: sysinfo['memoryavailablebytes'],
        memoryarcbytes: sysinfo['memoryarcbytes'],
...
Model.prototype.createUfdsServer = function (server, callback) {
    var self = this;
...
exports.sysinfoToLdapServer = sysinfoToLdapServer;
exports.Model = Model;
