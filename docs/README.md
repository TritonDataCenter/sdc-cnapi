...
- [Heartbeats](#heartbeats)
  - [heartbeating_servers_count](#heartbeating_servers_count)
  - [reconciler_new_heartbeaters_total](#reconciler_new_heartbeaters_total)
  - [reconciler_stale_heartbeaters_total](#reconciler_stale_heartbeaters_total)
  - [reconciler_usurped_heartbeaters_total](#reconciler_usurped_heartbeaters_total)
  - [reconciler_server_put_total](#reconciler_server_put_total)
  - [reconciler_server_put_etag_failures_total](#reconciler_server_put_etag_failures_total)
  - [reconciler_server_put_failures_total](#reconciler_server_put_failures_total)
  - [reconciler_status_put_total](#reconciler_status_put_total)
  - [reconciler_status_put_etag_failures_total](#reconciler_status_put_etag_failures_total)
  - [reconciler_status_failures_total](#reconciler_status_failures_total)
...
- [Waitlist](#waitlist)
    - [Request (create) a ticket](#request-create-a-ticket)
    - [Display all tickets](#display-all-tickets)
    - [Wait on a ticket](#wait-on-a-ticket)
    - [Release a ticket](#release-a-ticket)
