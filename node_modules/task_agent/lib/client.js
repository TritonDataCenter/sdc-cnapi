...
Client.prototype.connect = function(callback) {
  ...
  this.connection.addListener('error', function (e) {
    console.error("There was an AMQP error: " + e.message);
  });

  this.connection.addListener('close', function () {
    console.warn('MQ connection severed.');
    if (!self.config.reconnect) return;
    console.warn('Waiting 5 seconds...');
    setTimeout(function () {
...
Client.prototype.useConnection = function (connection, callback) {
  var self = this;
  console.warn("Reusing AMQP connection.");
  self.agentHandles = {};
...
AgentHandle.prototype.sendTask = function (task, msg, callback) {
  ...
  var taskHandle = this.taskHandles[msg.task_id] = new TaskHandle();
